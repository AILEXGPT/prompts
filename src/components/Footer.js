    ...
    <div className="flex flex-col w-full justify-center items-center mb-6">
      <div className="flex flex-row flex-wrap space-x-2">
        ...
        <a
          ...
          href="https://twitter.com/ailexgpt"
          target="_blank"
        ...
        <a
          ...
          href="https://github.com/ailexgpt"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          ...
          href="https://www.linkedin.com/einfachalex"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          ...
          href="https://www.instagram.com/ailexgpt"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <div className="w-full flex justify-center items-center text-zinc-800">
        <a
          ...
          rel="noopener noreferrer"
        >
          {"</>"} & Crafted with&nbsp;💛&nbsp;AilexGPT by EinfachAlex
        </a>
      </div>
    </div>
  );
